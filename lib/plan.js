...
export function buildMarkdownPlan(domain, score, fixes, details) {
  ...
  let md = "# AEO Ready Remediation Plan — " + cleanDomain + "\n\n";
  md += "> Automated Answer Engine Optimization (AEO) Fix Plan by AEOReady.xyz\n";
  ...
  md += "3. Run a re-assessment at `https://aeoready.xyz/report.html?d=" + cleanDomain + "&refresh=true` to confirm a verified 90+ score.\n";
